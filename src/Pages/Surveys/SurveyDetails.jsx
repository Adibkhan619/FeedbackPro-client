...
import { FaArrowAltCircleDown, FaComment, FaTags, FaUser } from "react-icons/fa";
...
const SurveyDetails = () => {
    ...
    return (
        <div className="lg:mx-24  mx-5 lg:my-8 md:my-3 my-3">
            <div className="flex-col flex lg:flex-row lg:gap-10 items-center lg:justify-around">
                <div className="lg:w-1/2 space-y-3">
                    ...
                    <h1 className="dmSerif text-xl font-semibold">{description}</h1>

                                {/* VOTING */}
                <div className="lg:w-fit mt-5 card rounded-2xl  dark:bg-base-100 shadow-md bg-white">
                    <div className=" space-y-3 card-body p-5">
                        <p className="w-fit font-semibold flex text-white items-center gap-2  bg-sky-400 px-3 py-1 rounded-3xl"><FaArrowAltCircleDown className="text-xl"/>Cast Your Vote Here</p>
            ...
            {currentUser?.role === "pro-user" ? (
                <form onSubmit={handleAddComment} className="mt-10 lg:w-1/2 lg:mx-24 md:mx-12">
                    <div className="form-control ">
                        <label className="label">
                            <span className="label-text text-2xl font-semibold">Add comment</span>
                        </label>
                        <input
                            type="text"
                            name="comment"
                    ...
                    <button type="submit" className="btn rounded-xl mt-5 bg-sky-300 text-base-100">
                        Add Your feedback
                    </button>
                </form>
            ) : (
                ...
                {/* COMMENT */}
                            <div className="lg:mt-10 lg:mx-24 md:mx-12">
                                <h1 className="text-2xl font-semibold">Comments</h1>
                                {comments?.map((item, idx) => (
                                    <div key={idx}>
                                        <div className="card p-5 shadow-md lg:w-1/2">
