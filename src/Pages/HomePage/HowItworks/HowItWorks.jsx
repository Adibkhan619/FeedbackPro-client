...
const HowItWorks = () => {
    return (
        <div className=" card mx-5 bg-base-100 rounded-xl p-10  space-y-24">
            ...
            <Link to="/surveys"><button className="btn mt-8 border-2 text-sky-400 font-bold border-sky-400">Explore Now</button></Link>
            </div>
            ...
            <Link to="/signUp"> <button className="btn mt-8 border-2 text-sky-400 font-bold border-sky-400">Join Now</button></Link>
            </div>
